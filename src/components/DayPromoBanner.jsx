...
───────────────────────────────────────────────────────────── */
export default function DayPromoBanner({ promos, dayMatches, onDeletePromo, onUpdatePromo, isAdmin }) {
    ...
    <>
      ...
      {selectedPromo && (
        <DayPromoDetailModal
          ...
          onDelete={() => { onDeletePromo?.(selectedPromo.id); setSelectedPromo(null); }}
          onUpdate={(id, data) => { onUpdatePromo?.(id, data); setSelectedPromo(null); }}
          isAdmin={isAdmin}
        />
      )}
    </>
