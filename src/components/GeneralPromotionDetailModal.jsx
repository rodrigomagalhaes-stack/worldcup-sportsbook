...
export default function GeneralPromotionDetailModal({ promotion, onClose, onEdit, onDelete, isAdmin }) {
      ...
      <motion.div
        ...
        <motion.div
          ...
          <div style={{
            ...
            <button
              onClick={onClose}
              aria-label="Fechar detalhes da promoção"
              style={{
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '24px' }}>
            ...
            {promotion.created_at && (
              <div style={{
                ...
                <div>
                  <span style={{ fontWeight: 600 }}>Criada:</span> {new Date(promotion.created_at).toLocaleString('pt-BR', {
